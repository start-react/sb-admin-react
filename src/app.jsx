...
const rootRoute = {
  ...
  childRoutes: [ {
      ...
      childRoutes: [
        ...
        require('./components/pages/dashboard/Tables'),
        require('./components/pages/dashboard/Forms'),
        require('./components/pages/dashboard/PanelsWells'),
        require('./components/pages/dashboard/Buttons'),
        require('./components/pages/dashboard/Notifications'),
        require('./components/pages/dashboard/Typography'),
        require('./components/pages/dashboard/Icons'),
        require('./components/pages/dashboard/Grid'),
        require('./components/pages/dashboard/Blank'),
        require('./components/pages/dashboard/FlotCharts'),
        require('./components/pages/dashboard/MorrisjsCharts'),
        require('./components/pages/Login'),
        require('./components/pages/Logout')
      ]
    },
    {
      path: '/login',
